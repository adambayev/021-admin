...
const navGrants = [
  ...
  { to: '/grantgivers', name: 'Грантодатели', exact: true, Icon: MdSend },
  { to: '/subjects', name: 'Сфера/ дисциплина', exact: true, Icon: MdSend },
  { to: '/organizations', name: 'Организация', exact: true, Icon: MdSend },
  {
    to: '/programcategories',
    name: 'Категория программы',
    exact: true,
    Icon: MdSend,
  },
];
